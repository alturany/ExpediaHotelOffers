...
public class HotelInfo implements Serializable
{
    ...
    private final static long serialVersionUID = -3133946067591953407L;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(hotelId).append(name).append(hotelDestination).append(hotelDestinationRegionID).append(hotelLongDestination).append(hotelStreetAddress).append(hotelCity).append(hotelProvince).append(hotelCountryCode).append(hotelLocation).append(hotelLatitude).append(hotelLongitude).append(hotelStarRating).append(hotelGuestReviewRating).append(travelStartDate).append(travelEndDate).append(hotelImageUrl).append(carPackageScore).append(description).append(distanceFromUser).append(language).append(movingAverageScore).append(promotionAmount).append(promotionDescription).append(promotionTag).append(rawAppealScore).append(relevanceScore).append(statusCode).append(statusDescription).append(carPackage).append(allInclusive).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(hotelId, rhs.hotelId).append(name, rhs.name).append(hotelDestination, rhs.hotelDestination).append(hotelDestinationRegionID, rhs.hotelDestinationRegionID).append(hotelLongDestination, rhs.hotelLongDestination).append(hotelStreetAddress, rhs.hotelStreetAddress).append(hotelCity, rhs.hotelCity).append(hotelProvince, rhs.hotelProvince).append(hotelCountryCode, rhs.hotelCountryCode).append(hotelLocation, rhs.hotelLocation).append(hotelLatitude, rhs.hotelLatitude).append(hotelLongitude, rhs.hotelLongitude).append(hotelStarRating, rhs.hotelStarRating).append(hotelGuestReviewRating, rhs.hotelGuestReviewRating).append(travelStartDate, rhs.travelStartDate).append(travelEndDate, rhs.travelEndDate).append(hotelImageUrl, rhs.hotelImageUrl).append(carPackageScore, rhs.carPackageScore).append(description, rhs.description).append(distanceFromUser, rhs.distanceFromUser).append(language, rhs.language).append(movingAverageScore, rhs.movingAverageScore).append(promotionAmount, rhs.promotionAmount).append(promotionDescription, rhs.promotionDescription).append(promotionTag, rhs.promotionTag).append(rawAppealScore, rhs.rawAppealScore).append(relevanceScore, rhs.relevanceScore).append(statusCode, rhs.statusCode).append(statusDescription, rhs.statusDescription).append(carPackage, rhs.carPackage).append(allInclusive, rhs.allInclusive).isEquals();
    }
